...
const LoginView: React.FC<{ onLogin: (user: User) => void }> = ({
  ...
  return (
    <div className='min-h-screen flex items-center justify-center p-4 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-[#0B1120] to-black'>
      <div className='w-full max-w-md relative'>
        ...
        <div className='relative bg-slate-900/80 backdrop-blur-xl border border-slate-800 p-8 rounded-2xl shadow-2xl'>
          <div className='text-center mb-8'>
            <div className='w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl mx-auto flex items-center justify-center mb-4 shadow-lg shadow-indigo-500/20 transform rotate-3 hover:rotate-0 transition-all duration-500'>
